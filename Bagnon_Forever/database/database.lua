...
function BagnonDB.GetClass(player)
	if BagnonForeverData[currentRealm][player] then
		colorize = BagnonForeverData[currentRealm][player].c
		if colorize=="Druid" then
			return "|cffFF7D0A"
		elseif colorize=="Hunter" then
			return "|cffABD473"
		elseif colorize=="Mage" then
			return "|cff69CCF0"
		elseif colorize=="Paladin" then
			return "|cffF58CBA"
		elseif colorize=="Priest" then
			return "|cffFFFFFF"
		elseif colorize=="Rogue" then
			return "|cffFFF569"
		elseif colorize=="Shaman" then
			return "|cff0070DE"
		elseif colorize=="Warlock" then
			return "|cff9482C9"
		elseif colorize=="Warrior" then
			return "|cffC79C6E"
		else
			return "|cff00B4FF"
		end
